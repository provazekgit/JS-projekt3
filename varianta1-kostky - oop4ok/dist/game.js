...
const trowAgainSection = document.getElementById("trowAgain");
...
function updateButtonBackgrounds() {
    ...
    const rollAgainButton = trowAgainSection.querySelector("button");
    if (rollAgainButton) {
 ...
 */
function animateDiceRoll(finalValue1, finalValue2) {
 ...
 */
function setupThrowAgainButton() {
